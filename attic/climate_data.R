...
#keep information on station and precipitation
...
#add day to date, so it can be converted
...
### rndaa is inconsistent (station ids are not only id but sometimes "ghcnd")
#, allows a max of 10 years of data. not to recommend
